...
-- 9. charcaters 테이블의 master_id컬럼은 employees 테이블의 manager_id와 같은 역할을 한다.
...
-- 두컬럼은 각각 star_wars와 characters 테이블의 기본키를 ㅊ ㅏㅁ조하고 있다.
-- 참조키를 생성하라

-- 제약 조건 : NOT NULL, CHECK , UNIQUE, PRIMARY KEY, FOREIGN KEY
--              컬럼, 컬럼/테이블 ~
--                              <-- 복합키   -->
...
-- star_wars 테이블의 character_id 컬럼을 참조하는 casting 테이블의 episode_id 컬럼에 FK 제약조건 지정
ALTER TABLE casting
